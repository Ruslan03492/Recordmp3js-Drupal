...
(function (window) {
  ...
  var Recorder = function (source, cfg) {
      ...
      fileReader.onload = function () {
        ...
        encoderWorker.onmessage = function (e) {
          if (e.data.cmd == 'data') {
            ...
            var fname = 'audio_recording_' +
              Drupal.settings.quiz_voice_answer.nid +
              '_' + Drupal.settings.quiz_voice_answer.uid + '.mp3';
            uploadAudio(mp3Blob, fname);
            ...
            div.appendChild(br);
            div.appendChild(hf);
            recordingslist.innerHTML = div.innerHTML;
          }
        };
      };
    ...
    function uploadAudio(mp3Data, fname) {
      var reader = new FileReader();
      reader.onload = function (event) {
        var fd = new FormData();
        var mp3Name = encodeURIComponent(fname);
        document.getElementById("tries").value = event.target.result;
      };
